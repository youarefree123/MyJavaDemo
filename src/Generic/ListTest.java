...
public class ListTest {
    ...
    public void testAdd(){
        ...
        // 对象数组的形式添加
        Student [] stu  = {new Student("3", "王五"), new Student("4", "马六")};

        // Arrays类包含用来操作数组（比如排序和搜索）的
        // 各种方法，asList() 方法用来返回一个受指定数组
        // 支持的固定大小的列表
        ...
        students.addAll(2,Arrays.asList(stu2));
